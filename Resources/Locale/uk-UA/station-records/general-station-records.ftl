...
general-station-record-console-empty-state = Записів не знайдено!
general-station-record-console-no-record-found = Запис для обраної особи не знайдено.
...
general-station-record-job-filter = Професія
