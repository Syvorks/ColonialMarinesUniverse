shared-solution-container-component-on-examine-empty-container = Не містить хімікатів.
shared-solution-container-component-on-examine-main-text = Містить {INDEFINITE($desc)} [color={$color}]{$desc}[/color] {$wordedAmount}
