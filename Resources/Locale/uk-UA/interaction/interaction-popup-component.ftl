...
petting-success-soft-floofy = {THE($target)} отримує ващі пестощі по {POSS-ADJ($target)} голові.
...
petting-success-dog = {THE($target)} отримує ващі пестощі по {POSS-ADJ($target)} голові.
...
petting-failure-shadow = Ви намагаєтесь погладити {THE($target)}, але ваша рука проходить крізь холодну темряву {POSS-ADJ($target)} тіла.
...
petting-success-cleanbot = Ви гладите {THE($target)} по {POSS-ADJ($target)} вологій металевій голові.
petting-success-medibot = Ви гладите {THE($target)} по {POSS-ADJ($target)} стерильній металевій голові.
...
petting-success-mail-teleporter = Ви гладите {THE($target)} по {POSS-ADJ($target)} відданому, холодному корпусу.
petting-failure-mail-teleporter = Ви тягнетеся погладити {THE($target)}, але {SUBJECT($target)} {CONJUGATE-BE($target)} зайнятий сортуванням пошти!
