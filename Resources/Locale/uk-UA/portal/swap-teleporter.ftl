...
swap-teleporter-popup-teleport-other = {CAPITALIZE(THE($entity))} активується, і ви опиняєтесь десь в іншому місці.
swap-teleporter-popup-teleport-fail = {CAPITALIZE(THE($entity))} активується, але не вдається телепортувати вас нікуди.
