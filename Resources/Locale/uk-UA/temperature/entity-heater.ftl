...
entity-heater-examined = Він налаштований на { $setting ->
...
entity-heater-switch-setting = Перемкнути на { -entity-heater-setting-name(setting: $setting) }
entity-heater-switched-setting = Перемкнено на { -entity-heater-setting-name(setting: $setting) }.
