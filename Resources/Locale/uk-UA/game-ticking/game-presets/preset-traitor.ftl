...
traitor-role-codewords = Кодові слова: [color = lightgray]
    {$codewords}.[/color]
    Кодові слова можна використовувати у звичайній розмові, щоб тихо ідентифікувати себе іншим агентам синдикату.
    Прислухайтеся до них і тримайте у секреті.
traitor-role-uplink-code = Встановіть свій рінгтон на ноти [color = lightgray]{$code}[/color], щоб блокувати або розблокувати свій аплінк.
    Не забудьте заблокувати після, інакше екіпаж станції теж легко відкриє його!
...
traitor-role-codewords-short = Кодові слова:
    {$codewords}.
traitor-role-uplink-code-short = Ваш код аплінку: {$code}. Встановіть його як рінгтон ПДА для доступу до аплінку.
