...
cargo-console-menu-populate-orders-cargo-order-row-product-name-text = {$productName} (x{$orderAmount}) від {$orderRequester} з [color={$accountColor}]{$account}[/color]
cargo-console-menu-cargo-order-row-approve-button = Схвалити
cargo-console-menu-cargo-order-row-cancel-button = Скасувати
...
cargo-console-paper-reason-default = Немає
